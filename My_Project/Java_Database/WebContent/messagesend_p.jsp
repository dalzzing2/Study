...
<%@ page import="java.sql.*"%>
	...
	<center>
		...
		<h1>메시지보내기</h1>
		<hr color=green width=500>
		<form action="messagemid_pd.jsp" method="POST">
		메시지 아이디 : <input type="text" name="messageid"><br><br>
		의사 아이디 : <input type="text" name="doctorid"><br><br>
		유형 : <input type="radio" name="type" value="진찰">진찰
		<input type="radio" name="type" value="예약">예약<br><br>
		제목 : <input type="text" name="title"><br><br>
		<input type="hidden" name="signature" value="<%session.getAttribute("patientid"); %>">
		...
		<form action="patient_info.jsp" method="POST"><input type="submit" value="돌아가기">
		</form>
	</center>
</body>
</html>