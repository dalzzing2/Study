...
import com.example.explicitintenttest.MemoDBHelper;
...
public class MemoContentProvider extends ContentProvider {
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs){
		...
		switch(code){
			case ONE_MEMO:
				String where = MemoDBHelper.colID + " = " + uri.getPathSegments().get(1) + (selection == null || selection.length() == 0? "" : " AND " + selection);
